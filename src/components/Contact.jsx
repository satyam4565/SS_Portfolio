  ...
  return (
    <section id='contact' className='section'>
        <div className='container lg:grid lg:grid-cols-2 lg:items-stretch'>
            ...
            <form action='https://getform.io/f/anlqmeza' method='POST' className='xl:pl-10 2xl:pl-20 '>
                <div className='md-grid md:items-center md:grid-cols-2 md:gap-2' > 
                    <div className='mb-4'>
                        <label htmlFor='name' className='label'>Name</label>
                        <input type='text' name='name' id='name' autoComplete='name' required placeholder='Example' className='text-field'></input>
                    </div>

                    <div className='mb-4'>
                        <label htmlFor='email' className='label'>Email</label>
                        <input type='email' name='email' id='email' autoComplete='email' required placeholder='satyam@example.com' className='text-field'></input>
                    </div>
                </div>
                <div className='mb-4'>
