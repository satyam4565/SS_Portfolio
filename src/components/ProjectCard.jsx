...
const ProjectCard = ({
  ...
  return (
    <div className={"relative p-4 rounded-2xl bg-zinc-800 hover:bg-zinc-700/50 active:bg-zinc-700/60 ring-1 ring-inset ring-zinc-500/5 transition-colors" + classes}>
